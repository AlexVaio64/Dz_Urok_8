...
int dim1 = InputInt("Введите значение X: ");
int dim2 = InputInt("Введите значение Y: ");
int dim3 = InputInt("Введите значение Z: ");
int countNumbers = 89;

if (dim1 * dim2 * dim3 > countNumbers)
{
    Console.Write( "Внимание! Массив слишком большой!" );
    return;
}
